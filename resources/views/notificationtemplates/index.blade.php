                ...
                <div class="row justify-content-between gy-3">
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="col-md-12">
                            ...
                            <form method="post" action="{{ route('notificationtemplate.bulk_action') }}"
                                id="quick-action-form" class="form-disabled d-flex gap-3 align-items-center">
                                @csrf
            ...
            window.renderedDataTable = $('#datatable').DataTable({
                ...
                columns: [{
                    ...
                    //  { data: 'id', name: 'id', title: "{{ __('messages.id') }}" , orderable: false, },
                    {
                        data: 'label',
                        name: 'label',
                        title: "{{ __('messages.template_name') }}",
                    },
