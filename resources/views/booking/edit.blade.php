                        ...
                        {{ Form::model($bookingdata,['method' => 'patch', 'route'=>['booking.update',$bookingdata->id], 'data-toggle'=>"validator" ,'id'=>'booking'] ) }}
                            ...
                            <div class="row">                            
                                <div class="form-group col-md-4">
                                    ...
                                    <br />
                                    {{ Form::select('status',$status,old('status'),[ 'id' => 'status' ,'class' =>'form-select select2js booking_status']) }}
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    {{ Form::select('payment_status',['pending' => __('messages.pending') , 'paid' => __('messages.paid') ,'failed' => __('messages.failed') ],optional($bookingdata->payment)->payment_status,[ 'id' => 'payment_status' ,'class' =>'form-select select2js','required']) }}
                                </div>
                                @endif
                            </div>
                            <div class="row">
