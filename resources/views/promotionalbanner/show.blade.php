            ...
            <div class="card-body">
                <div class="row justify-content-between gy-3">
                    <div class="col-md-6 col-lg-6 col-xl-6">
                            ...
                            <p><strong>{{ __('messages.date') }}: {{ \Carbon\Carbon::parse($banner->start_date)->format('M d, Y') }} To {{ \Carbon\Carbon::parse($banner->end_date)->format('M d, Y') }} </strong></p>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6">
                        <div class="mt-3 d-flex gap-3 align-items-center justify-content-end">
                            ...
                            @if($banner->status == 'accepted')
                                    <span class="badge badge-active text-success bg-success-subtle">{{ __('messages.accepted') }}</span>
