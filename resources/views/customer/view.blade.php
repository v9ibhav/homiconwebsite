                            ...
                            <div class="card card-block card-stretch">
                                <div class="card-body p-0">
                                    <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                                        ...
                                        <a href="{{ route('user.index') }}   " class=" float-end btn btn-sm btn-primary"><i class="fa fa-angle-double-left"></i> {{ __('messages.back') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                @else
                                                    <tr>
                                                        <td colspan="5" class="text-center fw-bold">{{__('messages.record_not_found')}}</td>
                                                    </tr>
                                                @endif
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="table-responsive-sm">
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                @else
                                                <tr>
                                                    <td colspan="4" class="text-center fw-bold">{{__('messages.record_not_found')}}</td>
                                                </tr>
                                                @endif
                                            </tbody>
                                        </table>
                            ...
                            <div class="card card-block p-4">
                                <div class="profile-box">
                                    <div class="profile-card rounded">
                                        <img src="{{ getSingleMedia($customerdata,'profile_image') }}" alt="profile-bg" class="profile-image avatar-100 d-block mx-auto mb-3 rounded-circle position-relative">
                                        <h3 class="font-600 text-white text-center mb-5">{{$customerdata->display_name}}</h3>
                                    </div>
                                    <div class="pro-content rounded">
                                        <div class="d-flex align-items-center gap-3 mb-3">
                                            <div class="p-icon flex-shrink-0">
