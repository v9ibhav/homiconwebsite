    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        {{ html()->form('POST', route('user.changepassword'))->attribute('data-toggle', 'validator')->id('user')->open()}}
                        <div class="row">
                            <div class="col-md-3 d-md-block d-none"></div>
                            <div class="col-md-6">
                                {{ html()->hidden('id', $customerdata->id ?? null)->class('form-control')->placeholder('id') }}
