                    ...
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            ...
                            @if ($auth_user->can('document add'))
                                <a href="{{ route('document.create') }}" class=" float-end me-1 btn btn-sm btn-primary"><i
            ...
            <div class="card-body">
                <div class="row justify-content-between gy-3">
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="col-md-12">
                            <form action="{{ route('document.bulk-action') }}" id="quick-action-form"
                                ...
                                <div class="select-status d-none quick-action-featured" id="change-featured-action"
                                    style="width:100%">
                                    <select name="is_required" class="form-select select2" id="is_required"
                                        style="width:100%">
                                ...
                                <button id="quick-action-apply" class="btn btn-primary" data-ajax="true"
                                    data--submit="{{ route('document.bulk-action') }}" data-datatable="reload"
