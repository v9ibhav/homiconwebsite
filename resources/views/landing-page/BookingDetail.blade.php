                        ...
                        <div class="col-md-8">
                            ...
                            @endif
                                ...
                                <div id="payment-component" style="display: none;">
                                    <payment
                                        :is_enable_advance_payment="{{$bookingData['service']['is_enable_advance_payment'] == 1 ? 1 : 0}}"
                ...
                <div class="col-lg-6 py-5 position-relative pe-xl-5">
                    ...
                    @foreach ($services as $service)
                        @php
                            ...
                            $service_image = isset($service['attchments'][0]) ? $service['attchments'][0] : asset('images/default.png');
                                ...
                                <div>
                                    ...
                                    <div class="d-sm-flex gap-2 my-3">
                                        <ul class="list-inline mt-sm-0 mt-2 mb-0 p-0 d-flex align-items-center flex-wrap category-list lh-1">
                                            <li class="me-2">{{ $category_name }}</li>
                                            <li class="text-primary">{{ $subcategory_name }}</li>
                                        </ul>
                                    </div>
...
@endif
                                    ...
                                    @endif
                                    @php
                                        $totalamount = $bookingData['booking_detail']['post_request_id'] == null ? getPriceFormat($bookingData['booking_detail']['final_sub_total']) : getPriceFormat($bookingData['booking_detail']['total_amount']);
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="d-block text-end">{{ $subtotal }}</span>
                                        </td>
                                    </tr>

                                    @if($bookingData['booking_detail']['post_request_id'] == null)
                                    <tr>
                                        <td>
                            ...
                            @endif
                                    ...
                                    <tr>
                                        <td>
                                            <span class="text-capitalize">{{__('messages.refund_amount')}}</span>
                                        </td>
                                        <td>
                                            <span class="d-block text-end text-danger">{{ getPriceFormat($bookingData['booking_detail']['refund_amount']) }}</span>
                                        </td>
                                    </tr>
                                    @endif -->
                                </tbody>
